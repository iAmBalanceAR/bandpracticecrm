...
export default function PDFGrid({ title, songs, includeNotes = true, includeKey = true }: PDFGridProps) {
  return (
        ...
        <table style={pdfStyles.songList}>
          <thead>
            <tr>
              ...
              {includeKey && <th style={pdfStyles.headerCell}>Key</th>}
          ...
          <tbody>
            {songs.map((song, index) => (
              <tr key={index} style={pdfStyles.songRow}>
                ...
                {includeKey && <td style={pdfStyles.songCell}>{song.key}</td>}
