      ...
      <div className="h-full px-3 py-4 bg-[#111c44] shadow-lg flex flex-col justify-between">
        <div>
          ...
          <nav className="space-y-2">
            <Link href="/" className="block hover:bg-[#131d43]">
            ...
            <Link href="/calender" className="block">
              <Button variant="ghost" className={`w-full justify-${sidebarOpen ? 'start' : 'center'} text-gray-400 text-lg ${!sidebarOpen ? 'p-0' : 'px-2'}`}>
